    ...
    <div class="row">
      <div class="col-sm-3">
        ...
        <div class="card mt-2 leftSideCard">
          <div class="card-body">
            <!-- body start -->
            <user-card-info active="desc"></user-card-info>
            <!-- body stop -->
          </div>
        </div>
      </div>
...
import ProfileDescription from '../../components/ProfilSettings/ProfileDescription.vue'

export default {
  name: "UserProfile",
  components: { navBar, UserCardInfo, ProfileDescription},
};
</script>
